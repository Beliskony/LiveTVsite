...
const FeaturesListSection = () => {
  return (
    <div className="flex flex-col gap-y-4 lg:min-h-[400px] xl:min-h-[500px] border-b border-gray-700 p-10 lg:p-16 xl:p-20 md:flex-row lg:flex-row xl:flex-row justify-center xl:justify-start lg:justify-start items-center">
