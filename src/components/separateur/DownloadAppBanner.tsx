...
const DownloadAppBanner = () => {
  return (
    <div className="border-b-2 border-white flex flex-row max-sm:flex-col gap-x-2 max-sm:gap-y-2 items-center lg:justify-start md:justify-center w-full text-gray-900 px-2 md:px-7
     lg:px-10 xl:px-16 xl:pb-2.5 2xl:pb-2.5 lg:pb-2.5 md:pb-2.5 my-5 max-sm:pb-1 shadow-2xl">
            <h1 className="text-left text-white font-medium">Télécharger l'applicaton{""} <span className="font-bold">YeshouaApp</span></h1>
