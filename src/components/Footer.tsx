...
export default function Footer() {
  ...
  return (
    <footer className="bg-[#1faae1] text-white">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          ...
          <div className="space-y-4">
            ...
            <ul className="space-y-2 max-sm:justify-center flex flex-row lg:flex-col gap-x-4">
              <li><Link to="/egliseYeshoua/presentation" className="text-white hover:text-white">Eglise de Yeshoua</Link></li>
              <li><Link to="/contact" className="text-white hover:text-white">Contact TV</Link></li>
            </ul>
          </div>
          ...
          {/* <h3 className="text-lg hidden max-sm:font-bold max-sm:text-2xl max-sm:text-center font-semibold">Nos applications</h3>
            <div className="space-y-2 justify-center items-center max-sm:flex max-sm:flex-row max-sm:gap-x-6">
              <Link to="/app/mobile" className=" items-center space-x-2 text-white hover:text-white hidden">
                <Smartphone className="h-5 w-5" />
                <span className='max-sm:hidden'>Application mobile</span>
                <span className='sm:hidden'>App mobile</span>
              </Link>
              <Link to="/app/tv" className="hidden items-center space-x-2 text-white hover:text-white">
                <Tv className="h-5 w-5" />
                <span className='max-sm:hidden'>Application TV</span>
                <span className='sm:hidden'>App TV</span>
              </Link>
              <Link to="/app/web" className="hidden items-center space-x-2 text-white hover:text-white">
            ...
            <div className="max-sm:flex max-sm:flex-col max-sm:items-center max-sm:justify-center max-sm:gap-y-2">
              ...
              <div className="flex space-x-4 max-sm:gap-x-10">
                <a href="https://www.facebook.com/profile.php?id=61579857472689&mibextid=wwXIfr&rdid=fjV2WY1X4Kvxyu7b&share_url=https%3A%2F%2Fwww.facebook.com%2Fshare%2F17MhswwegK%2F%3Fmibextid%3DwwXIfr#" target="_blank" className="text-white hover:text-white">
                  <Facebook className="h-6 w-6 max-sm:h-8 max-sm:w-8" />
                  <span className="sr-only">Facebook</span>
                </a>
                <a href="https://www.tiktok.com/@eglisedeyeshoua" target="_blank" className="text-white hover:text-white">
                  <img src='/tiktok.svg' alt='tiktokIcon' className="h-6 w-6 max-sm:h-8 max-sm:w-8" />
                  <span className="sr-only">Tiktok</span>
                </a>
                <a href="https://www.youtube.com/@EGLISEDEYESHOUA" target="_blank" className="text-white hover:text-white">
        ...
        <div className="mt-12 max-sm:mt-6 border-t border-white pt-6 text-center text-sm text-white">
