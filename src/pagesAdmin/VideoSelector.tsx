...
interface SelecteurVideoProps {
  onVideoSelect: (file: File | null) => void
  selectedFile?: File | null
}

export function SelecteurVideo({ onVideoSelect, selectedFile }: SelecteurVideoProps) {
        ...
        <div className="border rounded-lg p-4 bg-gray-50">
          ...
          {previewUrl && (
            <div className="relative">
              <video src={previewUrl} className="w-full h-32 object-cover rounded bg-black" controls={false} />
